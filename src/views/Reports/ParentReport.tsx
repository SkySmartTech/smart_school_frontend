...
  // Removed year state and set a default
...
    {
      queryKey: ["parent-report", studentId || '', exam, month], // Removed year from query key
      queryFn: () => {
        if (!studentId) throw new Error("Student ID not available");
        // Pass month to the API call directly
        return fetchParentReport(studentId, "2023", exam, month); // Hardcoded year and passed month
      },
      enabled: !!studentId,
      retry: 1
...
  // Removed useEffect for month reset as month filter is now permanent
...
                </TextField>
                {/* Month Dropdown is now always visible */}
                <TextField
                  select
                  label="Month"
                  value={month}
