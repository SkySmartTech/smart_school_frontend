...
    useEffect(() => {
        // FIX: Compare against the standardized value MONTHLY_EXAM_VALUE
...
            // Send empty string for month when not Monthly exam - API will convert to "null"
            // FIX: Use MONTHLY_EXAM_VALUE for comparison
...
                                        onChange={e => setMonth(e.target.value)}
                                        // FIX: Use MONTHLY_EXAM_VALUE for comparison to enable/disable
